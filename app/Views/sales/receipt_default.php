...
<div id="receipt_wrapper" style="font-size: 12px !important; max-width: 320px; margin: 0 auto; padding: 15px; background: #fff; box-shadow: 0 0 5px rgba(0,0,0,0.2);">
    ...
    <div style="text-align: center; margin-top: 20px;">
        <img src="<?= base_url('images/enp.PNG') ?>" alt="ENP" style="max-width: 100%;" />
    </div>
</div>
