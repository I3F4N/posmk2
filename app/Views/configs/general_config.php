...
<?= form_open('config/saveGeneral/', ['id' => 'general_config_form', 'enctype' => 'multipart/form-data', 'class' => 'form-horizontal']) ?>
    <div id="config_wrapper">
        <fieldset id="config_info">
            ...
            <div class="form-group form-group-sm">
                <?= form_label('Cost Price %', 'cost_price_percentage', ['class' => 'control-label col-xs-2 required']) ?>
                <div class="col-xs-2">
                    <div class="input-group">
                        <?= form_input([
                            'name'  => 'cost_price_percentage',
                            'id'    => 'cost_price_percentage',
                            'class' => 'form-control input-sm required',
                            'type'  => 'number',
                            'min'   => 0,
                            'max'   => 100,
                            'value' => isset($config['cost_price_percentage']) && $config['cost_price_percentage'] !== '' ? $config['cost_price_percentage'] : 55
                        ]) ?>
