...
return [
    ...
    "whatsapp_sent"                    => "WhatsApp Receipt successfully sent to",
    "whatsapp_unsent"                  => "WhatsApp Receipt failed to be sent to",
    "whatsapp_no_phone"                => "Customer does not have a valid phone number",
