...
<head>
    ...
    <style>
        @import url('https://fonts.googleapis.com/css2?family=League+Spartan:wght@800&family=Montserrat&display=swap');
        ...
        .topbar, .navbar {
            background-color: #88BEE2 !important;
            border-color: #88BEE2 !important;
        }

        .topbar a, .navbar a, .navbar .nav > li > a {
            color: #FFFFFF !important;
        }

        .topbar a:hover, .navbar a:hover, .navbar .nav > li > a:hover {
            background-color: #76a9ca !important;
        }
        ...
        <div class="navbar navbar-default" role="navigation">
            <div class="container">
                <div class="navbar-header">
                    ...
                    <a class="navbar-brand hidden-sm" href="<?= site_url() ?>">GRAFF</a>
                </div>
